...
// Source: github.com/fourbetween/app-supportocol/internal/model/project (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen -package project -destination ./repository_mock.go . Repository
//
...
func (m *MockRepository) Delete(project *Project) error {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) Delete(project any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockRepository)(nil).Delete), project)
}
...
func (mr *MockRepositoryMockRecorder) Save(project any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockRepository)(nil).Save), project)
}
