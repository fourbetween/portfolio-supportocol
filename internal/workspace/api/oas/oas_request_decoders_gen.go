...
func (s *Server) decodeV1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostRequest(r *http.Request) (
	req *V1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostReq,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/json":
		...
		var request V1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostReq
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
