...
// Encode implements json.Marshaler.
func (s *V1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostReq) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *V1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostReq) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("discussionIds")
		e.ArrStart()
		for _, elem := range s.DiscussionIds {
			elem.Encode(e)
		}
		e.ArrEnd()
	}
...
var jsonFieldsNameOfV1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostReq = [1]string{
	0: "discussionIds",
}

// Decode decodes V1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostReq from json.
func (s *V1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostReq) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode V1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostReq to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "discussionIds":
			requiredBitSet[0] |= 1 << 0
			if err := func() error {
				s.DiscussionIds = make([]ID, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem ID
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.DiscussionIds = append(s.DiscussionIds, elem)
					return nil
				}); err != nil {
					return err
				}
				...
				return errors.Wrap(err, "decode field \"discussionIds\"")
			}
		default:
			return d.Skip()
		}
		...
		return errors.Wrap(err, "decode V1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostReq")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfV1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostReq) {
					name = jsonFieldsNameOfV1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostReq[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *V1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *V1WorkspaceWorkspacesWorkspaceIdProjectsProjectIdDiscussionsMovePostReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
