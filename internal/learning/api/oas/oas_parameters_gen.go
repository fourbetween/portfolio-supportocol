...
// V1AiLearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsPostParams is parameters of POST /v1/ai/learning/workspaces/{workspaceId}/discussions/{discussionId}/comments operation.
type V1AiLearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsPostParams struct {
	WorkspaceId  ID
	DiscussionId ID
}

func unpackV1AiLearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsPostParams(packed middleware.Parameters) (params V1AiLearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsPostParams) {
	{
		key := middleware.ParameterKey{
			Name: "workspaceId",
			In:   "path",
...
func decodeV1AiLearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsPostParams(args [2]string, argsEscaped bool, r *http.Request) (params V1AiLearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsPostParams, _ error) {
	// Decode path: workspaceId.
	if err := func() error {
		param := args[0]
		if argsEscaped {
