...
func (s *Discussion) Validate() error {
	...
	if err := func() error {
		if value, ok := s.DialogueSettings.Get(); ok {
			if err := func() error {
...
func (s *V1LearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsPutReq) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *V1LearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsPutReqCommentsItem) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
	...
	var failures []validate.FieldError
	if err := func() error {
		if value, ok := s.ParentIndex.Get(); ok {
			if err := func() error {
				if err := (validate.Int{
					MinSet:        true,
					Min:           0,
...
func (s *V1LearningWorkspacesWorkspaceIdDiscussionsDiscussionIdStatusPutReq) Validate() error {
	...
	if err := func() error {
		if value, ok := s.CommentFrame.Get(); ok {
			if err := func() error {
				if err := value.Validate(); err != nil {
					return err
				}
