...
func (s *Server) decodeV1LearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsCommentIdIssuesIssueIdStatusPutRequest(r *http.Request) (
	req *V1LearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsCommentIdIssuesIssueIdStatusPutReq,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/json":
		...
		var request V1LearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsCommentIdIssuesIssueIdStatusPutReq
		if err := func() error {
...
func (s *Server) decodeV1LearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsCommentIdIssuesPostRequest(r *http.Request) (
	req *V1LearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsCommentIdIssuesPostReq,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/json":
		...
		var request V1LearningWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsCommentIdIssuesPostReq
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
