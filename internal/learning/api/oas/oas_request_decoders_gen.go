...
func (s *Server) decodeLearningDiscussionsDiscussionIdPublishPostRequest(r *http.Request) (
	req *LearningDiscussionsDiscussionIdPublishPostReq,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/json":
		...
		var request LearningDiscussionsDiscussionIdPublishPostReq
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
