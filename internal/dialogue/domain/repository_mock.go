...
func (mr *MockDiscussionRepositoryMockRecorder) Search(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Search", reflect.TypeOf((*MockDiscussionRepository)(nil).Search), ctx)
}
