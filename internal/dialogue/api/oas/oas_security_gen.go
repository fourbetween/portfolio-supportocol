...
var operationRolesCookieAuth = map[string][]string{
	V1DialogueDiscussionsGetOperation: []string{},
	V1DialogueWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsCommentIdIssuesPostOperation: []string{},
	V1DialogueWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsGetOperation:                 []string{},
	V1DialogueWorkspacesWorkspaceIdDiscussionsDiscussionIdCommentsPostOperation:                []string{},
	V1DialogueWorkspacesWorkspaceIdDiscussionsDiscussionIdGetOperation:                         []string{},
	V1DialogueWorkspacesWorkspaceIdDiscussionsGetOperation:                                     []string{},
}
